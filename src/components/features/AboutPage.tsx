      ...
      <div className="relative pt-20 h-[60vh] sm:h-[65vh] md:h-[70vh] min-h-[500px] sm:min-h-[550px] md:min-h-[600px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6 md:px-8">
          ...
          >
            ...
            >
              Leading the transformation of municipal governance with
              innovative technology, trusted expertise, and unwavering
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                For over two and a half decades, Sthapatya Consultants Pvt. Ltd.
                has been a trusted name in transforming municipal governance
                through innovation, precision, and technology. With a strong
                foundation in property tax survey, GIS-based asset mapping,
                e-governance systems, and smart municipal solutions, we have
                successfully partnered with over 150 Urban Local Bodies (ULBs)
                across Maharashtra and India.
              </p>
              <p>
                Our journey reflects a legacy of excellence from manual surveys
                to AI-driven smart governance maintaining our core values of
                integrity, trust, and performance. As we step into the future,
                we continue to innovate through AI, cloud infrastructure,
                blockchain-enabled verification, and citizen-centric mobile
                solutions, ensuring that governance is not only digital but also
                intelligent, inclusive, and sustainable.
              </p>
              <p
                className="px-6 py-4 bg-gray-50 rounded-xl border-l-4 italic"
                style={{ borderLeftColor: colors.primary }}
              >
                "Transforming urban governance through innovation, dedication,
                and excellence"
              </p>

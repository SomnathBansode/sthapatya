      ...
      <div className="relative pt-24 sm:pt-20 md:pt-20 h-auto min-h-[650px] sm:h-auto sm:min-h-[600px] md:h-auto md:min-h-[680px] lg:h-[70vh] lg:min-h-[700px] overflow-hidden pb-6 sm:pb-6 md:pb-8 lg:pb-0">
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6 md:px-8 py-4 sm:py-6 md:py-8 lg:py-10">
          ...
          >
            ...
            >
              Connect with us for any inquiries or support. We're committed to
              helping you transform municipal governance.
            </motion.p>
            ...
            >
              ...
              <div className="bg-white/10 backdrop-blur-sm border-2 border-white/30 rounded-xl md:rounded-2xl p-3.5 sm:p-4 md:p-5 lg:p-6 text-center hover:bg-white/20 transition-all">
                ...
                >
                  <Phone size={18} className="text-white sm:hidden" />
                  <Phone size={19} className="hidden sm:block md:hidden text-white" />
                  <Phone size={20} className="hidden md:block lg:hidden text-white" />
                  <Phone size={24} className="hidden lg:block text-white" />
                </div>
                <h3
              ...
              <div className="bg-white/10 backdrop-blur-sm border-2 border-white/30 rounded-xl md:rounded-2xl p-3.5 sm:p-4 md:p-5 lg:p-6 text-center hover:bg-white/20 transition-all">
                <div
                  ...
                  style={{ backgroundColor: colors.accent }}
                >
                  <Mail size={18} className="text-white sm:hidden" />
                  <Mail size={19} className="hidden sm:block md:hidden text-white" />
                  <Mail size={20} className="hidden md:block lg:hidden text-white" />
                  <Mail size={24} className="hidden lg:block text-white" />
                </div>
                <h3
                  className="text-sm sm:text-sm md:text-base lg:text-lg mb-1 sm:mb-1.5 md:mb-2 text-white"
                  style={{ fontWeight: 600 }}
              ...
              <div className="bg-white/10 backdrop-blur-sm border-2 border-white/30 rounded-xl md:rounded-2xl p-3.5 sm:p-4 md:p-5 lg:p-6 text-center hover:bg-white/20 transition-all sm:col-span-2 md:col-span-1">
                <div
                  ...
                  style={{ backgroundColor: colors.accent }}
                >
                  <Clock size={18} className="text-white sm:hidden" />
                  <Clock size={19} className="hidden sm:block md:hidden text-white" />
                  <Clock size={20} className="hidden md:block lg:hidden text-white" />
                  <Clock size={24} className="hidden lg:block text-white" />
                </div>
                <h3
                  className="text-sm sm:text-sm md:text-base lg:text-lg mb-1 sm:mb-1.5 md:mb-2 text-white"
                  style={{ fontWeight: 600 }}

          ...
          >
            <motion.div
              className={`w-0.5 transition-all ${
                activeSection === section.id ? "h-12 bg-[#D84040]" : "h-8 bg-[#8E1616]"
              }`}
              animate={{
                height:
            ...
            <motion.div
              ...
              animate={{
                opacity:
                  hoveredSection === section.id || activeSection === section.id ? 1 : 0,
                x:
                  hoveredSection === section.id || activeSection === section.id ? 0 : 10,
              }}
